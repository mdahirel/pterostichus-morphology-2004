...
xcoords <- tibble(
  model = c("distance to centre","IMD (100m)","IMD (300m)",
...
**Figure S3-1.** Posterior estimates for the standardised fixed effect of urbanisation $\beta_{1}$, depending on the urbanisation metric used in the model. Note that the sign of the posterior values for distance to city centroid has been reversed to make the comparison with the other posteriors easier (as distances to city centroid decrease when urbanisation increases).
