...
Evaluations of these models revealed slight but consistent evidence of overdispersion (see archived data analysis code<!--ref?-->). We therefore fitted beta-binomial models to account for that overdispersion [@harrisonComparisonObservationlevelRandom2015]:
