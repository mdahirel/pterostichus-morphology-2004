...
```{r data}
raw_counts <-read_csv(here("data","pterostichus_madidus_2004_2005.csv"))
raw_sites <-read_sf(here("data","rennes2004_sites_centroids.gpkg"),layer="rennes2004_sites_centroids")
ucdb_centroid <- read_sf(here("data","rennes_ucdb_2015_centroid.gpkg"),layer="rennes_ucdb_2015_centroid")
ucdb_extent <- read_sf(here("data","rennes_ucdb_2015_extent.gpkg"),layer="rennes_ucdb_2015_extent")
